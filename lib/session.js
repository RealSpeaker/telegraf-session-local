 ...
 * @param {Object} [options.storage] - lowdb storage option for implementing your own storage read/write operations `(default: {@link https://git.io/vhMqm|storageFileAsync})`
...
class LocalSession {
  ...
  /**
   * lowdb storage/adapter named `{@link hhttps://git.io/vhMqm|FileAsync}`
   *
   * @memberof! LocalSession
